    ...
    <div className="container" style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div className="glass animate-fade-in" style={{ width: '100%', maxWidth: '400px', padding: '2.5rem 2rem' }}>
        <div className="text-center mb-6">
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '0.875rem' }}>Improve your campus, one report at a time.</p>
        </div>

        <h2 className="text-center mb-4" style={{ fontSize: '1.25rem', fontWeight: '700' }}>Welcome Back</h2>
